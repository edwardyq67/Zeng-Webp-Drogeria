                        ...
                        <div className="flex flex-col md:flex-row justify-between items-center">
                            ...
                            <div className="flex gap-6 mt-4 md:mt-0">
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer" className="text-gray-400 hover:text-white text-sm transition-colors">
                                    Mapa del Sitio
                                </a>
                            </div>
                        </div>
                        ...
                        <div className="absolute bottom-16 right-0 mb-2 space-y-2 animate-fade-in">
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    <p className="font-medium text-sm">WhatsApp 1</p>
                                    <p className="text-xs text-gray-600 truncate">{contacto.telefono1}</p>
                                </div>
                            </a>
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    <p className="font-medium text-sm">WhatsApp 2</p>
                                    <p className="text-xs text-gray-600 truncate">{contacto.telefono2}</p>
                                </div>
                            </a>
                        </div>
                    )}
